...
//        return imgPathList;
     ...
     * @return 返回文件访问路径
     */
    public static List<String> fileHandle(MultipartFile[] myfiles, HttpServletRequest request,String childrenPath){
        //处理上传图片
...
/*                System.out.println("文件长度: " + myfile.getSize());
                ...
                String realPath = WebPath.rootPath+"//WEB-INF//upload//"+childrenPath;
                out.println("上传文件的目录是："+realPath);
                //使用自定义文件资源库     正式发布后，在确定图片放哪里后，才用这个
                //String realPath = WebPath.rootParentPath+"//MySAUImages//"+childrenPath;
