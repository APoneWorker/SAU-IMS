...
public class SauMsgPublicController {
    ...
    public Map<String,Object> getMassageType(@RequestParam("messageType")int messageType, HttpSession session){
        ...
        clubObjMap1.put("clubId",1);
        clubObjMap1.put("clubName","乒乓球协会");
        Map<String,Object> clubObjMap2 = new LinkedHashMap<String, Object>();
        clubObjMap2.put("clubId",1);
        clubObjMap2.put("clubName","羽毛球协会");
    ...
    public Map<String,Object> getAllOldMsg(HttpSession session){
        ...
        msgMap1.put("messageTitle","校社联网站已经建设完成，请个社团完善自己信息");
        ...
        msgMap2.put("messageTitle","校社联网站已经建设完成，各个同学进行注册");
    ...
    public Map<String,Object> getOneOldMsg (@PathVariable int messageId,HttpSession session){
        ...
        //模拟数据
        String messageTitle = "新网站通知";
        String messageContent = "新网站已经建成，请各个社团尽快完善本社团信息";
        //后端要精确的秒
        ...
        publishedObjMap1.put("clubId",1);
        publishedObjMap1.put("clubName","乒乓球协会");

        //创建发布对象的map集合
        Map<String,Object> publishedObjMap2 = new LinkedHashMap<String, Object>();
        publishedObjMap2.put("clubId",2);
        publishedObjMap2.put("clubName","羽毛球协会");
    ...
    public Map<String,Object> sendMsgToPerson (@RequestBody SauPublishedNewMsgDomain newMsg,HttpSession session) {
        ...
        if(newMsg!=null){
            ...
            if(publishObject!=null) {
                //遍历前端发过来的发布id的list集合，从map集合中得到社团id，并将它放入到id的list集合中
                for (Map<String, Integer> clubIdMap : publishObject) {
                    clubIdList.add(clubIdMap.get("clubId"));
                }
            }
            ...
            out.println("clubIdList:"+clubIdList);

            out.println("将该消息存入数据库（发送给指定的用户（社团）的）："+newMsg+"社团id的list集合为："+clubIdList);
        }else {
            returnData.setStateCode(ResponseCode.REQUEST_ERROR,"所要发布的消息内容为空，不能发布");
        }
    ...
    public Map<String,Object> searchMsg (@RequestParam String findContent,HttpSession session) {
        ...
        if(findContent!=null){
            ...
            Map<String,Object> msgMap1 = new LinkedHashMap<String, Object>();
            msgMap1.put("messageId",101);
            msgMap1.put("messageTitle","校社联网站已经建设完成，请个社团完善自己信息"+"。查找内容是;"+findContent);
            msgMap1.put("sendTime",new Date());
            msgMap1.put("messageType",2);
            //用来装某条信息的map集合
            Map<String,Object> msgMap2 = new LinkedHashMap<String, Object>();
            msgMap2.put("messageId",102);
            msgMap2.put("messageTitle","完善消息"+"。查找内容是;"+findContent);
            msgMap2.put("sendTime",new Date());
            msgMap2.put("messageType",0);
